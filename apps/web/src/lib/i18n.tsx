...
const translations = {
  ...
  "dash.title": { ru: "Дашборд продукта", en: "Product Dashboard" },
  "dash.week": { ru: "Неделя", en: "Week" },
  "dash.planFact": { ru: "План / Факт", en: "Plan / Actual" },
  "dash.replenishments": { ru: "Пополнения", en: "Replenishments" },
  "dash.revenue": { ru: "Доход", en: "Revenue" },
  "dash.yearPlan": { ru: "Годовой план", en: "Annual Plan" },
  "dash.yearProgress": { ru: "Выполнение годового плана", en: "Annual Plan Progress" },
  "dash.plan": { ru: "План", en: "Plan" },
  ...
  "dash.activeUsers": { ru: "Активные пользователи", en: "Active Users" },
  "dash.avgCheck": { ru: "Средний чек", en: "Average Check" },
  "dash.newUsers": { ru: "Новые пользователи", en: "New Users" },
  "dash.problems": { ru: "Проблемы и решения", en: "Problems & Solutions" },
  "dash.problemsPlaceholder": { ru: "Опишите текущие проблемы и план их решения...", en: "Describe current problems and resolution plan..." },
  "dash.tasksThisWeek": { ru: "Задачи на эту неделю", en: "Tasks This Week" },
  "dash.tasksLastWeek": { ru: "Статус задач прошлой недели", en: "Last Week Tasks Status" },
  "dash.addTask": { ru: "Добавить задачу", en: "Add Task" },
  "dash.taskTitle": { ru: "Название задачи", en: "Task title" },
  "dash.dueDate": { ru: "Срок", en: "Due date" },
  "dash.status": { ru: "Статус", en: "Status" },
  "dash.planned": { ru: "Запланировано", en: "Planned" },
  "dash.inProgress": { ru: "В работе", en: "In Progress" },
  "dash.completed": { ru: "Выполнено", en: "Completed" },
  "dash.blocked": { ru: "Заблокировано", en: "Blocked" },
  "dash.blocker": { ru: "Блокер", en: "Blocker" },
  "dash.newDeadline": { ru: "Новый срок", en: "New deadline" },
  "dash.save": { ru: "Сохранить", en: "Save" },
  "dash.saving": { ru: "Сохранение...", en: "Saving..." },
  "dash.editPlan": { ru: "Редактировать план", en: "Edit Plan" },
  "dash.noData": { ru: "Нет данных из БД — проверьте подключение", en: "No DB data — check connection" },
  "dash.behindPlan": { ru: "Отставание от плана", en: "Behind plan" },
  "dash.onTrack": { ru: "В рамках плана", en: "On track" },
  "dash.aheadOfPlan": { ru: "Опережение плана", en: "Ahead of plan" },
